  ...
  return (
    <div className="rounded-lg bg-sky-50 p-2">
      ...
      <table className="w-full text-sm">
        <thead><tr className="text-slate-400"><th className="text-left font-medium">Trimestre</th><th className="text-right font-medium">2025 (a la fecha)</th><th className="text-right font-medium">Total 2025</th><th className="text-right font-medium">2026</th><th className="text-right font-medium">Dif</th></tr></thead>
        <tbody>
...
function TablaMeses({ nodo }: { nodo: NodoMicrogerencia }) {
  return (
    <div className="rounded-lg bg-amber-50 p-2">
      ...
      <table className="w-full text-sm">
        <thead><tr className="text-slate-400"><th className="text-left font-medium">Mes</th><th className="text-right font-medium">2025 (a la fecha)</th><th className="text-right font-medium">Total 2025</th><th className="text-right font-medium">2026</th><th className="text-right font-medium">Dif</th></tr></thead>
        <tbody>
          {nodo.meses.map((m, i) => (
